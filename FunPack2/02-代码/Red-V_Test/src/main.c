...
//    my_print("DCV16(10,100,'HelloWorld',1);\r\n");
   ...
   uint8_t str[] = "Hello World012345678901234567890123456789";
   OLED_Init();
   OLED_Display_On();
   OLED_Clear();
   OLED_ShowString(0,0,str,sizeof(str));
//   OLED_ShowString(0,10,str,sizeof(str));
//   OLED_ShowString(0,20,str,sizeof(str));
//   OLED_ShowString(0,30,str,sizeof(str));
